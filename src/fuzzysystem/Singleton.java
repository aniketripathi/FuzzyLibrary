...
/**
 * Singleton class represents the pair ({@link Element} element, double membership). The singleton element should always
 * be obtained in
 * context of a fuzzy set. The membership value is always in reference to a fuzzy set. A singleton element should never
 * be used independently or
 * with the other instances of this class.
 * 
 * <p>
 * Consider instances of this class as {@linkplain Element} instance associated to a fuzzy set or membership function.
 * 
...
public final class Singleton {
	...
	/**
	 * Creates a <i>Singleton</i> instance from the element and its membership values. Since the membership value can be
	 * entered directly,
	 * it should be avoided for consistency.
	 * 
	 * @throws MembershipOutOfException
	...
	/**
	 * A generic constructor. Creates a <i>Singleton</i> instance from the element. The membership value of the element
	 * is obtained by the <b>Type</b> fuzzySet.
	...
	/**
	 * Returns the name of the instance. It is the same as the string representation of the
	 * {@linkplain Singleton#element}.
	 * 
	...
	/**
	 * Creates a new <i>Singleton</i> instance which is complement of the this instance. The complement of
	 * <i>Singleton</i> <em><b>A</em></b>
	 * is the ordered pair (element, 1 - membership value of element). The reference to {@linkplain Element} object in
	 * <em><b>this</em></b> is same as in the complement
	 ...
	 * <i>Singleton</i> <em><b>A</em></b>
	 * is the ordered pair (element, 1 - membership value of element). The reference to {@linkplain Element} object in
	 * complement is specified in the parameter.
	 ...
	 * 
	 * <p>
	 * for example : (x1, 1.0) (Aniket, 0.5) etc. The first part is the string representation of {@linkplain#element}.
	 * </p>
	 * 
	 */
	@Override
